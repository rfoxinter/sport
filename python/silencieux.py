...
def nouveau_b_c():
    ...
    b_c.remove('bras_cardio/burpees.jpg')
    b_c.remove('bras_cardio/mountain-climbers.jpg')
    b_c.remove('bras_cardio/mountain-climbers-taps.jpg')
    b_c.remove('bras_cardio/speed-walkout.jpg')
    b_c.remove('bras_cardio/sprawls.jpg')

def nouveau_j():
    global j
    j=['jambes/'+i for i in listdir('images/jambes')]
    j.remove('jambes/jumping-lunges.jpg')
    j.remove('jambes/jump-squat.jpg')
...
e.remove('echauffement/pogo-jump.jpg')
e.remove('echauffement/pogo-jump-single.jpg')
l=['a','j','b_c']
pre='j'
Image=Label(root)
